...
const router = Router();
    ...
    router.put("/:productId",isAuth,checkRole(["admin"]),  ProductsController.updateProduct);
    // Ruta DELETE para eliminar un producto por su ID
    router.delete("/:productId",isAuth,checkRole(["admin"]),  ProductsController.deleteProduct);
